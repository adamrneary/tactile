describe 'Scatter series', ->
    ...
    it 'addSeries', ->
        ...
        assert Chart.series[Chart.series.length-1].name is 'actual-planned-dots'
        assert Chart.series[Chart.series.length-1].renderer is 'scatter'
        assert Chart.series[Chart.series.length-1].color is '#F52A2D'
        ...
        assert typeof Chart.series[Chart.series.length-1].cssConditions is 'function'
