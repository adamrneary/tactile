...
Tactile.AreaRenderer = AreaRenderer = (function(_super) {
  ...
  AreaRenderer.prototype.render = function(transition) {
    ...
    this.transition.selectAll("#" + (this._nameToId()) + " circle").attr("r", function(d) {
      if ("r" in d) {
        return d.r;
      } else {
...
Tactile.AxisLinear = AxisLinear = (function() {
...
Tactile.ColumnRenderer = ColumnRenderer = (function(_super) {
  ...
  ColumnRenderer.prototype.render = function(transition) {
    ...
    this.transition.selectAll("#" + (this._nameToId()) + " rect").attr("height", function(d) {
    ...
    this.transition.selectAll("#" + (this._nameToId()) + " circle").attr("cx", function(d) {
  ...
  ColumnRenderer.prototype.stackTransition = function(transition, transitionSpeed) {
    ...
    this.unstack = false;
    this.graph.discoverRange(this);
    transition.selectAll("#" + (this._nameToId()) + " rect").duration(transitionSpeed / 2).attr("y", this._barY).attr("height", function(d) {
      return _this.graph.y.magnitude(Math.abs(d.y));
    });
    transition.selectAll("#" + (this._nameToId()) + " circle").duration(transitionSpeed / 2).attr("cy", this._barY);
    transition.selectAll("#" + (this._nameToId()) + " rect").delay(transitionSpeed / 2).attr("width", this._seriesBarWidth()).attr("x", this._barX);
    return transition.selectAll("#" + (this._nameToId()) + " circle").delay(transitionSpeed / 2).attr("cx", function(d) {
      return _this._barX(d) + _this._seriesBarWidth() / 2;
    });
  };
  ...
  ColumnRenderer.prototype.unstackTransition = function(transition, transitionSpeed) {
    ...
    this.unstack = true;
    this.graph.discoverRange(this);
    transition.selectAll("#" + (this._nameToId()) + " rect").duration(transitionSpeed / 2).attr("x", this._barX).attr("width", this._seriesBarWidth());
    transition.selectAll("#" + (this._nameToId()) + " circle").duration(transitionSpeed / 2).attr("cx", function(d) {
      return _this._barX(d) + _this._seriesBarWidth() / 2;
    });
    transition.selectAll("#" + (this._nameToId()) + " rect").delay(transitionSpeed / 2).attr("height", function(d) {
      return _this.graph.y.magnitude(Math.abs(d.y));
    }).attr("y", this._barY);
    return transition.selectAll("#" + (this._nameToId()) + " circle").delay(transitionSpeed / 2).attr("cy", this._barY);
  };
...
(function() {
  var WaterfallRenderer, _ref,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

Tactile.WaterfallRenderer = WaterfallRenderer = (function(_super) {
...
Tactile.Series = Series = (function() {
...
Tactile.SeriesSet = SeriesSet = (function() {
