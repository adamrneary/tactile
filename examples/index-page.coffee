...
frameVal = [new Date(2012, 1, 1).getTime(), new Date(2012, 10, 1).getTime()] # = [2012-Feb-1, 2012-Dec-1]


# create instance of chart
chart = new Tactile.Chart({unstack: true, width: 900, height: 530})
...
toColumn.click (e) ->
  ...
  timeSlider.slider
    ...
    slide: (event, ui) ->
      ...
      chart.render()
  # add stack/group buttons
  $("#below-chart").prepend buttonGroup
